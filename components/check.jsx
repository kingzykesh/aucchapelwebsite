            ...
            >
              ...
              <form onSubmit={submitComplaint} className="space-y-6">
                ...
                >
                  ...
                  <option value="Attendance Incomplete">
                    Attendance Incomplete
                  </option>
                  <option value="Wrong Attendance Assigned">
                    Wrong Attendance Assigned
                  </option>
                ...
                <textarea
                  ...
                  className="w-full h-32 border border-gray-300 rounded-lg px-4 py-3"
                  value={form.details}
                  onChange={(e) =>
